...
preprocess_config = config['process_data']['interfence_mode']
...
async def inference(user_data: User):
    ...
    encoder = load(preprocess_config['encoder'])
    label_binarize = load(preprocess_config['label_bin'])
